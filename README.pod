...
You will also need to provide SSL certificate and private key pair.
Self-signed certificates are ok, see some
L<instructions from Telegram|https://core.telegram.org/bots/self-signed>.
